...
// 猜你喜欢
const { guessRef, onScrolltolower } = useGuessRef()
// 弹出层组件
...
const onOrderConfirm = () => {
  //二次弹窗确认
  uni.showModal({
    title: '为保障您的权益，请收到货并确认无误后，再确认收货',
    content: '',
    showCancel: true,
...
<template>
  <!-- 自定义导航栏: 默认透明不可见, scroll-view 滚动到 80 时展示 -->
