...
//立即购买
const onBayNow = (ev: SkuPopupEvent) => {
  ...
  <template v-if="isFinished">
    ...
    <scroll-view scroll-y class="viewport">
      ...
      <view class="goods">
        ...
        <!-- 操作面板 -->
        <view class="action">
          <view @tap="onOpenSku(SkuMode.Both)" class="item arrow">
            <text class="label">选择</text>
            <text class="text ellipsis"> {{ selectArrText }} </text>
          </view>
          <view @tap="openPopup('address')" class="item arrow">
            <text class="label">送至</text>
            <text v-if="selectedAddress" class="text ellipsis">
    ...
    <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
      ...
      <view class="buttons">
        <view @tap="onOpenSku(SkuMode.Cart)" class="addcart"> 加入购物车 </view>
        <view @tap="onOpenSku(SkuMode.Buy)" class="buynow"> 立即购买 </view>
      </view>
    </view>
  </template>
  <PageSkeleton v-else />
